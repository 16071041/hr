			...
			<div class="col-sm-12">
				<div class="ibox float-e-margins">
					...
					<div class="ibox-content">
						...
						<form method="post" class="form-horizontal" id="commentForm" action="<%=path %>/EmpServlet?method=doUpdateEmp">
							<div class="form-group">
								<label class="col-sm-3 control-label">工号</label>
								<div class="col-sm-7">
									<input type="hidden" name="id" value="<%=employee.getId() %>"/>
									<input type="text" class="form-control" name="employeeNumber" value="<%=employee.getEmployee_number() %>" readonly="readonly">
								</div>
							</div>
							<div class="form-group">
							...
							<div class="form-group">
								...
								<div class="col-sm-7">
									<select class="form-control m-b" name="departmentNumber" size="1" required>
										...
										<option value="2001">神经科</option>
										<option value="2002">内科</option>
									</select>
								</div>
							</div>
							<div class="form-group">
								...
								<div class="col-sm-7">
									<select class="form-control m-b" name="positionNumber" size="1" required>
										...
										<option value="3001">主任医师</option>
										<option value="3002">普通医师</option>
									</select>
								</div>
							</div>
							<div class="form-group">
