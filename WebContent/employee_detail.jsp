						...
						<form method="post" class="form-horizontal" action="">
						    <div class="form-group">
								...
								<div class="col-md-4">
							        ...
							        <p class="form-control-static"><%=employee.getEmployee_number() %></p>
						   		</div>
						   		<div class="col-md-4">
							...
							<div class="form-group">
								...
								<div class="col-md-4">
							        ...
							        <p class="form-control-static"><%=employee.getDepartment_number() %></p>
						   		</div>
						   		<div class="col-md-4">
							        <label class="col-sm-5 control-label">职称：</label>
							        <p class="form-control-static"><%=employee.getPosition_number() %></p>
							    </div>
							</div>
							<div class="form-group">
						    	<div class="col-md-1"></div>
						    	<div class="col-md-4">
							        <label class="col-sm-8 control-label">入职时间：</label>
							         <% String inttime = employee.getIn_time(); 	%>
							...
							<div class="form-group">
								<div class="col-sm-4 col-sm-offset-8">		
									<a href="<%=path %>/EmpServlet?method=findEmpList" class="btn btn-info">返&nbsp;&nbsp;回</a>
								</div>
							</div>
						</form>
					</div>
