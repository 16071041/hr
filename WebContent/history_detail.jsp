                    ...
                    <form method="post" class="form-horizontal" action="">
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                                ...
                                <p class="form-control-static"><%=history.getDepartment_number() %>
                                </p>
                            </div>
                            <div class="col-md-4">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                                ...
                                <p class="form-control-static"><%=history.getBirthday() %>
                                </p>
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                                ...
                                <p class="form-control-static"><%=history.getPosition_number()%>
                                </p>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                                ...
                                <p class="form-control-static"><%=history.getIn_time() %>
                                </p>
                            </div>
                            <div class="col-md-4">
