            ...
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    ...
                    <form method="post" class="form-horizontal" id="commentForm"
                          action="<%=path %>/OvertimeServlet?method=updateOvertimeById&id=<%=overtime.getId() %>">
                        <div class="form-group">
                            ...
                            <div class="col-sm-7">
                                <select class="form-control m-b" id="department" name="departmentNumber" size="1"
                                    ...
                                    %>
                                    <option value="<%=department.getDepartment_number() %>"
                                            <%
                                                if (overtime.getEmployee_number() == department.getDepartment_number()) {
                                            %>
                                            selected="selected"
                                            <% } %>
                                    >
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-7">
                                <select class="form-control m-b" id="employee" name="employeeNumber" size="1" required>
                                    ...
                                    %>
                                    <option value="<%=employee.getEmployee_number() %>"
                                            <%
                                                if (overtime.getEmployee_number() == employee.getEmployee_number()) {
                                            %>
                                            selected="selected"
                                            <% } %>
                                    >
